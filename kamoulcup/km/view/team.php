...
<div id='team_players'>
	...
	<ul>
		<!-- Begin player view -->
		<li class='team_player_container'>
			<div class='team_player_tab realPlayerInfo'>
				<h4>Mevlüt Erding</h4>
				<p><span class="playerPosition" title="Attaquant">A</span> Saint-Etienne</p>
			</div>
			<div class='team_player_tab gamePlayerInfo'>
				<div class='playerStats'>
					<p><i class='fa fa-line-chart'></i></p>
					<ul>
						<li class='stat' title='Dernier match'><span class='main emphasize'>12.45 pts</span><span class='annex'>Dernier</span></li>
						<li class='stat' title='Moyenne des 3 derniers matchs'><span class='main'>7.95 pts</span><span class='annex'>Moy. 3 matchs</span></li>
						<li class='stat' title='Moyenne sur toute la saison'><span class='main'>6.85 pts</span><span class='annex'>Moyenne</span></li>
					</ul>
				</div>
			</div>
		...
		<li class='team_player_container'>
			<div class='team_player_tab realPlayerInfo'>
				...
				<p><span class="playerPosition" title="Attaquant">A</span> Paris SG</p>
			</div>
			<div class='team_player_tab gamePlayerInfo'>
				<div class='playerStats'>
					<p><i class='fa fa-line-chart'></i></p>
			...
			<div class='team_player_tab teamPlayerInfo'>
				...
				<div class='teamPlayerInfo_action'>
					<a href='#' class='transferList_handle'><i class="fa fa-toggle-down"></i> Actions</a>
					<div class='transferList_actions'>
						<form method='post' id='firePlayerForm1478' action='#'>
							<input type='hidden' name='playerid' value='1478' />
							<button id="sendCartBtn">Libérer (0 Ka)</button>
						</form>
						<hr/>
						<form method='post' id='sellPlayerForm1478' action='#'>
							<input type='hidden' name='playerid' value='14785' />
							<p><label for='sellValue1478'>Mettre en vente à </label>
							<input type='text' id='sellValue1478' class='sellPrice_input' style="width:40px" maxLength='4' />
							Ka</p>
							<p><button id="sendCartBtn">Lister</button></p>
						</form>
					</div>
